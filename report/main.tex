...
The central objective of a reinforcement learning agent is to discover an optimal policy $\pi^*$ that maximizes the expected cumulative discounted return $J(\pi)$ over an episode:
\begin{equation}
    J(\pi) = \mathbb{E}_{\tau \sim \pi} \left[ \sum_{t=0}^{T} \gamma^t r_t \right]
\end{equation}
where $\tau = (s_0, a_0, r_0, s_1, \dots)$ denotes a trajectory sampled by following policy $\pi$, and $T$ is the time horizon of the episode.
